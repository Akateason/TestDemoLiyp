...
- (void)setAMember:(YPMemberInfo *)member {
    ...
    [self.imgUserHead sd_setImageWithURL:[NSURL URLWithString:member.avatar] placeholderImage:[UIImage imageNamed:@"userPlaceHolder"]] ;
    ...
    if (self.isAddMode && self.aMember.roleId == 0) {
        ...
        [self.btUserAccess setImage:[UIImage imageNamed:@"triangle1"] forState:0] ;
