...
- (UIButton *)btClose{
    if(!_btClose){
        _btClose = ({
            ...
            [object setImage:[UIImage shmyp_imageNamed:@"ie_topbar_btclose" fromBundleClass:self.class] forState:0] ;
...
- (UIButton *)btDelete{
    if(!_btDelete){
        _btDelete = ({
            UIButton * object = [[UIButton alloc]init];
            [object setImage:[UIImage shmyp_imageNamed:@"ie_topbar_btdelete" fromBundleClass:self.class] forState:0] ;
