...
- (IBAction)movingOnClick:(id)sender { // 确认
    NSDictionary *dic = @{
                          @"guid" : self.currentFolder.guid ?: @"" ,
                          @"type" : @(self.vType) ,
                          @"name" : self.currentFolder.name ?: @"石墨云盘"
                          } ;
...
- (void)viewDidLoad {
    ...
    [YPFolderCell xt_registerNibFromTable:_table bundleOrNil:[NSBundle bundleForClass:YPFolderCell.class]] ;
