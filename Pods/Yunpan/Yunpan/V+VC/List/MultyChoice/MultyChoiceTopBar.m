...
+ (instancetype)newFromCtrller:(UIViewController *)fromCtrller {
    UINib *nib = [UINib nibWithNibName:@"MultyChoiceTopBar" bundle:[NSBundle bundleForClass:self.class]] ;
    MultyChoiceTopBar *_eTopbar = [[nib instantiateWithOwner:nil options:nil] objectAtIndex:0] ;
    _eTopbar.delegate = (id)fromCtrller ;
